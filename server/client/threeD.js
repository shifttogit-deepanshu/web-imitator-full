...
function changePose(landmarks){
    ...
    leftShoulderHelper = drawArrowHelper({x:0,y:0,z:0},{x:-1,y:0,z:0})
    rightShoulderHelper = drawArrowHelper({x:0,y:0,z:0},{x:1,y:0,z:0})

    var coords = { x:0}; // Start at (0, 0)
	var tween = new TWEEN.Tween(coords) // Create a new tween that modifies 'coords'.
	.to({ x:300000}, 1000) // Move to (300, 200) in 1 second.
...
function handlePoseLandmarks(landmarks){	
	...
	if(!isPosingPose && model){
		...
		console.log(new THREE.Vector3(landmarks[15].x,landmarks[15].y,landmarks[15].z).distanceTo(new THREE.Vector3(landmarks[16].x,landmarks[16].y,landmarks[16].z)))
...
function init() {
	...
	loader.load( 'sophia.glb', function ( gltf ) {	
	...
	rightShoulder = model.getObjectByName( 'mixamorigRightShoulder' );
	rightArm = model.getObjectByName( 'mixamorigRightArm' );
	rightForeArm = model.getObjectByName( 'mixamorigRightForeArm' );
    rightHand = model.getObjectByName( 'mixamorigRightHand' );
	
	leftHandIndex1 = model.getObjectByName("mixamorigLeftHandIndex1")
	leftHandIndex2 = model.getObjectByName("mixamorigLeftHandIndex2")
	leftHandIndex3 = model.getObjectByName("mixamorigLeftHandIndex3")

	leftHandMiddle1 = model.getObjectByName("mixamorigLeftHandMiddle1")
	leftHandMiddle2 = model.getObjectByName("mixamorigLeftHandMiddle2")
	leftHandMiddle3 = model.getObjectByName("mixamorigLeftHandMiddle3")

	leftHandRing1 = model.getObjectByName("mixamorigLeftHandRing1")
	leftHandRing2 = model.getObjectByName("mixamorigLeftHandRing2")
	leftHandRing3 = model.getObjectByName("mixamorigLeftHandRing3")

	leftHandPinky1 = model.getObjectByName("mixamorigLeftHandPinky1")
	leftHandPinky2 = model.getObjectByName("mixamorigLeftHandPinky2")
	leftHandPinky3 = model.getObjectByName("mixamorigLeftHandPinky3")

	leftHandThumb1 = model.getObjectByName("mixamorigLeftHandThumb1")
	leftHandThumb2 = model.getObjectByName("mixamorigLeftHandThumb2")
	leftHandThumb3 = model.getObjectByName("mixamorigLeftHandThumb3")


		
	rightHandIndex1 = model.getObjectByName("mixamorigRightHandIndex1")
	rightHandIndex2 = model.getObjectByName("mixamorigRightHandIndex2")
	rightHandIndex3 = model.getObjectByName("mixamorigRightHandIndex3")

	rightHandMiddle1 = model.getObjectByName("mixamorigRightHandMiddle1")
	rightHandMiddle2 = model.getObjectByName("mixamorigRightHandMiddle2")
	rightHandMiddle3 = model.getObjectByName("mixamorigRightHandMiddle3")

	rightHandRing1 = model.getObjectByName("mixamorigRightHandRing1")
	rightHandRing2 = model.getObjectByName("mixamorigRightHandRing2")
	rightHandRing3 = model.getObjectByName("mixamorigRightHandRing3")

	rightHandPinky1 = model.getObjectByName("mixamorigRightHandPinky1")
	rightHandPinky2 = model.getObjectByName("mixamorigRightHandPinky2")
	rightHandPinky3 = model.getObjectByName("mixamorigRightHandPinky3")

	rightHandThumb1 = model.getObjectByName("mixamorigRightHandThumb1")
	rightHandThumb2 = model.getObjectByName("mixamorigRightHandThumb2")
	rightHandThumb3 = model.getObjectByName("mixamorigRightHandThumb3")

	neck = model.getObjectByName("mixamorigNeck")
	head = model.getObjectByName("mixamorigHead")

	rightArm.scale.set(rightArm.scale.x,rightArm.scale.y*0.9,rightArm.scale.z)
	leftArm.scale.set(leftArm.scale.x,leftArm.scale.y*0.9,leftArm.scale.z)

	leftForeArm.scale.set(leftForeArm.scale.x,leftForeArm.scale.y*1.1,leftForeArm.scale.z)
	rightForeArm.scale.set(rightForeArm.scale.x,rightForeArm.scale.y*1.1,rightForeArm.scale.z)
